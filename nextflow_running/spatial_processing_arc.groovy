...
process SPATIAL_CURIO {
	...
	echo "${params.outname}_rna,${params.outname}_rna,${params.date},${spatial_barcode},\${fq1},\${fq2},\${PWD}/filtered_feature_bc_matrix,TrekkerU_C,singularity,no,${task.cpus}" >> samplesheet.trekker.csv
